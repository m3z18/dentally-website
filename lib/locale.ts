...
export function publicNavigation(locale: Locale) { const t = ui[locale]; return [{ label: t.home, href: "/" }, { label: t.services, href: "/services" }, { label: t.doctors, href: "/doctors" }, { label: t.articles, href: "/articles" }, { label: t.about, href: "/about" }, { label: t.faq, href: "/faq" }, { label: locale === "en" ? "Gallery" : "المعرض", href: "/gallery" }, { label: t.contact, href: "/contact" }]; }
